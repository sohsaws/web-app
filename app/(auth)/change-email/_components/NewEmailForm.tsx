        ...
        <div className="bg-[#080808] flex items-center justify-center min-h-screen px-4">
            <div className="flex flex-col items-center gap-6 max-w-md rounded-2xl border border-white px-12 py-12">
                ...
                <div className="space-y-2 text-center">
                    <h1 className="text-xl font-semibold text-white">Enter your new email</h1>
                    <p className="text-sm text-neutral-500">
                        Your identity is confirmed. Enter the new email address you want to use.
                        It will be marked as verified automatically.
                    </p>
                </div>

                ...
                <div className="flex flex-col items-center gap-6 max-w-md rounded-2xl border border-white px-12 py-12 text-center">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-neutral-500">
                            ...
                            Click the link to proceed with changing your email.
                        </p>
                    </div>
                </div>
            </div>
    ...
    return (
        <div className="bg-[#080808] flex items-center justify-center min-h-screen px-6">
            <div className="flex flex-col items-center gap-6 max-w-md rounded-2xl border border-white px-12 py-12 text-center">
                ...
                <div className="space-y-2">
                    <h1 className="text-xl font-semibold text-white gap-2">Change your email</h1>
                    <p className="text-sm text-neutral-500">
                        First, we need to confirm your identity. We&apos;ll send a confirmation link to your current address{" "}
                        <span className="text-white">{userEmail}</span>.
                    </p>
                </div>
                <button
